<div class="flex h-screen overflow-hidden">
    ...
    <aside 
        ...
        class="fixed md:static inset-y-0 left-0 z-50 w-56 sm:w-64 bg-indigo-800 text-white flex flex-col"
        x-cloak
    >
        <!-- Logo -->
            ...
            <ul class="space-y-0.5 sm:space-y-1">
                ...
                <li>
                    <a href="{{ route('dashboard') }}" 
                       class="flex items-center px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-gray-300 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors {{ request()->routeIs('dashboard') ? 'bg-indigo-700 text-white' : '' }}">
                    ...
                    @if(auth()->user()->role === 'admin' || auth()->user()->role === 'agent')
                        ...
                        <li>
                            <a href="{{ route('localisations.index') }}" 
                               class="flex items-center px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-gray-300 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors {{ request()->routeIs('localisations.*') ? 'bg-indigo-700 text-white' : '' }}">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <li>
                            <a href="{{ route('biens.index') }}" 
                               class="flex items-center px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-gray-300 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors {{ request()->routeIs('biens.*') ? 'bg-indigo-700 text-white' : '' }}">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <li>
                            <a href="{{ route('inventaires.index') }}" 
                               class="flex items-center px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-gray-300 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors {{ request()->routeIs('inventaires.*') ? 'bg-indigo-700 text-white' : '' }}">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {{-- <li>
                            <a href="{{ route('rapports.index') }}" 
                               class="flex items-center px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-gray-300 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors {{ request()->routeIs('rapports.*') ? 'bg-indigo-700 text-white' : '' }}">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @if(auth()->user()->role === 'admin')
                        ...
                        <li>
                            <a href="{{ route('users.index') }}" 
                               class="flex items-center px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-gray-300 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors {{ request()->routeIs('users.*') ? 'bg-indigo-700 text-white' : '' }}">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {{-- <li>
                            <a href="{{ route('settings.index') }}" 
                               class="flex items-center px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-gray-300 rounded-lg hover:bg-indigo-700 hover:text-white transition-colors {{ request()->routeIs('settings.*') ? 'bg-indigo-700 text-white' : '' }}">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Footer Sidebar -->
        <div class="px-3 sm:px-4 py-3 sm:py-4 border-t border-indigo-700">
                ...
                @auth
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div 
                            ...
                            x-cloak
                        >
                            <a href="{{ route('profil') }}" class="block px-3 sm:px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Mon profil</a>
